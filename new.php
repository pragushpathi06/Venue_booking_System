                        ...
                        <div class="container">
                            ...
                            <form action="pick.php" method="post">
                                <div class="col">
                                    ...
                                    echo
                                    "<div class='row'><h5>Preference:   </h5><p>".$_SESSION['preference']."</p></div>".
                                    "<div class='row'><h5> Capacity:   </h5><p>".$_SESSION['capacity']."</p></div>".
                                    "<div class='row'><h5>Fromdate:   </h5><p>".$_SESSION['fromdate']."</p></div>".
                                    "<div class='row'><h5>Todate:   </h5><p>".$_SESSION['todate']."</p></div>".
                                    "<div class='row'><h5>Fromtime:   </h5><p>".$_SESSION['fromtime']."</p></div>".
                                    "<div class='row'><h5>Totime:   </h5><p>".$_SESSION['totime']."</p></div>"
                                    ;
                                    
                                    $sql = "SELECT * FROM classroom_details WHERE Hall_type='".$_SESSION['preference']."' AND Capacity>=".$_SESSION['capacity']." AND Projectors='".$_SESSION['projectors']."' AND Speakers='".$_SESSION['speakers']."' AND Classroom_no!='CE36' AND Classroom_no!='EC36' AND Classroom_no!='ME305' AND Classroom_no!='ME306' AND Classroom_no!='IT102' AND Classroom_no!='CS303'";
                                    $result = $conn->query($sql);
                                    ?>
                                    <br><br>
                                    <div class="row">
                                        <div class="input-group input-group-icon">                                        
                                            <select name="selectedvenue">
