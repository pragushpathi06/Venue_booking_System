        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <img src="complaint.png" width="20px" height="20px">
                    <b><span>COMPLAINTS REQUESTS</span></b>
                </a>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h4 class="m-0 font-weight-bold text-primary">Complaints</h4>
                        </div>
                        <div class="card-body">
                                ...
                                if ($result->num_rows > 0) {
                                    echo'<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        while($row = $result->fetch_assoc()) {                                    
                                            ...
                                            echo '<td>
                                            <form method="post"> 
                                            <button id="'.$i.'"  class="btn btn-danger btn-circle btn-sm" name="button'.$i.'">
                                            ...
                                            if(array_key_exists('button'.$i.'', $_POST)) {
                                                $sql1="UPDATE complaints SET status='Inactive' WHERE s_no='".$i."'";
                                                $conn->query($sql1);
