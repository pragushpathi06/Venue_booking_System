        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <img src="report.png" width="20px" height="20px">
                    <b><span>REGISTER COMPLAINTS</span></b>
                </a>
            </li>
                ...
                <!-- Begin Page Content -->
                    ...
                    <div class="container-fluid" >
                        <div class="container">
                            ...
                            <form action="emergency-insert.php" method="post">
                                <div class="col">
                                    <br>
                                    <center><h1>EMERGENCY VENUE OPTIONS</h1></center>
                                    <hr class="sidebar-divider">
                                    <br><br>
                                    <?php
                                    ...
                                    echo
                                    "<div class='row'><h5>Fromdate:   </h5><p>".$_SESSION['facultyid']."</p></div>".
                                    ...
                                    $sql = "SELECT * FROM emergency_venues ";
