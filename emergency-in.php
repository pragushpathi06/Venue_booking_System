        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <img src="report.png" width="20px" height="20px">
                    <b><span>REGISTER COMPLAIN</span></b>
                </a>
            </li>
            ...
            <li class="nav-item active">
                <a class="nav-link collapsed" href="emergency-in.php">
                <img src="complaint.png" width="20px" height="20px">
                    <b><span>EMERGENCY REQUESTS</span></b>
                </a>
            </li>
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">EMERGENCY REQUESTS</h6>
                        </div>
                        <div class="card-body">
                            ...
                            if($conn->connect_error){
                                ...
                                $sql = "SELECT * FROM emergency_venue_booking";
