                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            if($conn->connect_error){
                                ...
                                $sql = "SELECT * FROM classroom_details WHERE Classroom_no LIKE 'AG%' OR Classroom_no LIKE 'EE%' OR Classroom_no LIKE 'CT%' OR Classroom_no LIKE 'AIDS%' OR Classroom_no LIKE 'IB%' ";
