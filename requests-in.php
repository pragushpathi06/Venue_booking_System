                            ...
                            if ($result->num_rows > 0) {
                                echo'<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    while($row = $result->fetch_assoc()) {                                    
                                        ...
                                        echo '<td>
                                            <form method="post"> 
                                            <button id="a'.$i.'" onclick="button()" class="btn btn-success btn-circle btn-sm" name="button2'.$i.'">
                                            <i class="fas fa-check"></i>
                                            </button>
                                            &nbsp
                                            <button id="'.$i.'" onclick="button()" class="btn btn-danger btn-circle btn-sm" name="button'.$i.'">
                                            ...
                                            if(array_key_exists('button'.$i.'', $_POST)) {
                                                $sql1="UPDATE info SET Availability='Available' WHERE s_no='".$i."'";
                                                $conn->query($sql1);
                                                echo"<script>window.location.reload()
                                                history.back()</script>";
                                            }
                                            if(array_key_exists('button2'.$i.'', $_POST)) {
                                                $sql2="UPDATE info SET Availability='Booked' WHERE s_no='".$i."'";
                                                $conn->query($sql2);
                                                echo"<script>window.location.reload()
                                                history.back()</script>";
                                            }
